...
final skateTheme = ThemeData(
    ...
    bottomNavigationBarTheme: BottomNavigationBarThemeData(
      ...
      unselectedLabelStyle: const TextStyle(
          fontFamily: 'Karla', fontSize: 14, color: Colors.pink),
      selectedLabelStyle: const TextStyle(
          fontFamily: 'Karla', fontSize: 14, color: Colors.blue),
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
        ...
        style: ButtonStyle(
            backgroundColor:
                MaterialStateColor.resolveWith((states) => sDarkGreen),
            // textStyle not taking the appropriate color...
            textStyle: MaterialStateProperty.resolveWith((states) => skateTheme
                .textTheme.headline1!
